...
if __name__ == "__main__":
    ...
    if kwarg_dict.pop("run_aoe") is True and (
        args.measurement == "th_HS2_top_psa" or args.measurement == "th_HS2_lat_psa"
    ):
        pdf = eval(kwarg_dict.pop("pdf")) if "pdf" in kwarg_dict else standard_aoe

        sigma_func = (
            eval(kwarg_dict.pop("sigma_func")) if "sigma_func" in kwarg_dict else sigma_fit
        )
